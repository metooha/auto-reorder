...
export function ThemeEditorSection() {
  ...
  return (
    <div className={styles.themeSection}>
      <div>
        <h2 className={styles.themeSectionTitle}>Theme Token Editor</h2>
        <p className={styles.themeSectionDesc}>
          Override semantic tokens using values from the primitive color palette. Changes apply instantly and persist across sessions.
        </p>
      </div>
