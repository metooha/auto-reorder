...
export interface ChipProps
  ...
  /**
   * Visual variant controlling the selected-state appearance.
   * - `default`: dark border/fill on selected (INPUT tokens)
   * - `primary`: Walmart blue fill on selected (ACTION tokens)
   * @default 'default'
   */
  variant?: ChipVariant;
